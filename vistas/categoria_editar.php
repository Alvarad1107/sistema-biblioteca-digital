...
$id = $_GET['id'];
$resultado = $conn->query("SELECT * FROM categorias WHERE id = $id");
...
<body>
    ...
    <div class="container mt-5">
        <div class="card p-4 shadow-lg col-md-6 mx-auto">
            ...
            <form action="../procesos/categoria_actualizar.php" method="POST">
                <input type="hidden" name="id" value="<?php echo $categoria['id']; ?>">
                <div class="mb-3">
                    <label class="form-label">Nombre de la Categoría</label>
                    <input type="text" class="form-control" name="nombre" value="<?php echo htmlspecialchars($categoria['nombre']); ?>" required>
                </div>
                <div class="mb-4">
                    <label class="form-label">Descripción</label>
                    <textarea class="form-control" name="descripcion" rows="3"><?php echo htmlspecialchars($categoria['descripcion']); ?></textarea>
                </div>
