    ...
    <div class="container mb-5">
        <div class="main-card">
                ...
                <?php if (isset($_GET['status'])): ?>
                    <?php if ($_GET['status'] == 'guardado'): ?>
                        <div class="alert alert-success border-0 mb-4 rounded-3 shadow-sm fw-bold">
                            ...
                            <?php while($fila = $resultado->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="estudiante_eliminar.php?id=<?= $fila['id'] ?>" class="btn btn-sm btn-outline-danger fw-bold" onclick="return confirm('¿Estás seguro de que deseas eliminar este registro? Esta acción no se puede deshacer.');">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
